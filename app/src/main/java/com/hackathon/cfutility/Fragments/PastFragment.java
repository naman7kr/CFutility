...
import com.hackathon.cfutility.Adapters.PastFragmentAdapter;
...
public class PastFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view=inflater.inflate(R.layout.pastfragment,container,false);
        recyclerView = view.findViewById(R.id.past_rview);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        adapter =new PastFragmentAdapter(getContext(),list);
        ...
        try {
            ...
            if(job1.getString("status").compareTo("OK")==0) {
                ...
                for(int i=0;i<jsonArray.length();i++){
                    ...
                    if(temp.phase.compareTo("FINISHED")==0) {
                        list.add(temp);
                    }
